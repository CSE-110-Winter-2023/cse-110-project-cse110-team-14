...
public class AddingIconUITest {
    ...
    public void addingIconUITest() {
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.name),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        editText3.perform(replaceText("Parents"), closeSoftKeyboard());
        ...
        ViewInteraction editText6 = onView(
                allOf(withId(R.id.name), withText("Parents"),
                        withParent(withParent(withId(com.google.android.material.R.id.custom))),
                        isDisplayed()));
        editText6.check(matches(withText("Parents")));
